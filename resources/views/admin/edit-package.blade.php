               ...
               <div class="col-sm-12 col-xl-6">
                <div class="  h-100 p-xl-2 p-sm-0">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('package_name') is-invalid @enderror " id="inputPkgName" name="package_name" value="{{ old('package_name',$package->name) }}" autofocus>
                                @error('package_name')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control @error('package_price') is-invalid @enderror" id="inputPrice" name="package_price" value="{{ old('package_price',$package->price) }}">
                                @error('package_price')
                                <div class="invalid-feedback ">
                                    <span>{{ $message }}</span>
                                </div>   
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control @error('package_days') is-invalid @enderror" id="inputNumberOfDays" name="package_days" value="{{ old('package_days',$package->no_of_days) }}">
                                @error('package_days')
                                <div class="invalid-feedback ">
                                    <span>{{ $message }}</span>
                                </div>   
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select class="form-select @error('package_category') is-invalid @enderror mb-3" id="selectCateogry" name="package_category" >
                                    ...
                                    <option value="{{$cat->id}}" @selected(old('package_category',$package->category->id) == $cat->id) >{{$cat->category_name}}</option>                                        
                                    @endforeach
                                </select>
                            ...
                            <label for="packageImg" class="col-sm-2 col-form-label">Select Image</label>
                                <div class="col-sm-10">
                                    ...
                                    <div class="invalid-feedback ">
                                      ...
                                      @enderror 
                                      <img src="{{asset('storage/'.$package->image)}}" alt="{{$package->name}}" style="width: 70px;height: 70px;display: block;margin: 10px 0px;">                                                            
                                </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="featuredCheck" value="1" name="featured_package" {{ old('featured_package',$package->type) == '1' ? 'checked' : '' }}>                                
                                </div>
                            </div>
                        </div>
                    </div>
